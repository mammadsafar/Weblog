            ...
            <div class="card shadow-sm border-light px-0 py-3 p-md-4">
              <div class="card-body py-2">
                <div class="font-small mb-3"> <span>By</span>
                  ...
                  <time class="d-inline" pubdate="pubdate" datetime="Apr 01 2021">Last Update: ${moment(articles[i].lastUpdate).format('DD MMM YYYY')}</time>
                </div>
              ...
              <div class="card-footer mx-4 px-0 pt-0 mt-3 mt-lg-0">
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <a href="/all/readArticle${articles[i]._id}" class="btn btn-dark">More</a> <button type="button" 
